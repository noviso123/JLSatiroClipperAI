...
# --- INTERFACE ---
with gr.Blocks(title="JLSatiro AI Studio V7.0", theme=gr.themes.Soft()) as demo:
    gr.Markdown("# 🎬 JLSatiro Clipper AI - V7.0 (Gradio Edition)")
    gr.Markdown("**Tecnologia Nova: Conexão Direta (Sem Ngrok/Cloudflare)**")
