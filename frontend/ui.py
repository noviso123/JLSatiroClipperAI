...
# --- INTERFACE ---
with gr.Blocks(title="JLSatiro AI Studio V9.0", theme=gr.themes.Soft()) as demo:
    gr.Markdown("# 🎬 JLSatiro Clipper AI - V9.0 (PYTUBEFIX ENGINE)")
    gr.Markdown("### ⚡ Sistema de Cortes Virais Automáticos (Nova Tecnologia Download)")
